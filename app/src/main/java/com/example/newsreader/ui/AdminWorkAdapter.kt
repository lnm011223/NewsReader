 ...
 */
class AdminWorkAdapter(val workList: List<WorkItem>, val activity: Activity, val auth: String) :
    RecyclerView.Adapter<AdminWorkAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.adminwork_item, parent, false)
        ...
        viewHolder.review_btn.setOnClickListener {
            val position = viewHolder.adapterPosition
            val work = workList[position]
            val appService = UserServiceCreator.create<WorkService>()
            appService.verify(auth, work.id)
                    ...
                    override fun onResponse(call: Call<String>, response: Response<String>) {
                        ...
                        AlertDialog.Builder(activity).apply {
                            ...
                            setPositiveButton("是") { _, _ ->
                                viewHolder.review_btn.text = "已审核"
                            }
